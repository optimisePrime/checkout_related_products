...
for (let i = 0; i < 100; i += 1) {
  ...
  connection.query(
    `INSERT INTO items (item_id, name, price, stock, onList, rating, numOfRatings, relatedItems, imgUrl) values (' ${name}', ${price}, ${stock}, ${onList}, ${rating}, ${numOfRatings}, '${relatedItems}', '${imgUrl}')`,
    err => {
      if (err) {
        console.error(err);
      }
